...
ap.add_argument("-d", "--dataset", required = True, help = "path to in put dataset")
...
for imagePath in paths.list_images(args["dataset"]):
    #load the image, preprocess ot and store it in the data list
...
# trainX = np.asarray(trainX).astype(np.float32) #useless
...
#
# trainX = tf.convert_to_tensor(trainX) #useless
