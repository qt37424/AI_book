...
class AlexNet:
    ...
    def build(width, height, depth, classes, reg=0.0002):
        ...
        #các block này dựa vào cái bảng 10.1 á
        #Block #1: first CONV => RELU => POOl layer set
        model.add(Conv2D(96, (11, 11), strides = (4, 4),input_shape = inputShape, padding = "same", kernel_regularizer=12(reg)))
        model.add(Activation("relu"))
        model.add(BatchNormalization(axis = chanDim))
        model.add(MaxPooling2D(pool_size = (3, 3), strides = (2, 2))) #lấy ở dòng pool
